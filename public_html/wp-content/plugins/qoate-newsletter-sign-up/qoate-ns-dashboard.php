		...
		<div class="metabox-holder">	
			<div class="meta-box-sortables">
				<div class="postbox">
					...
					<div class="inside">
					<p style="font-weight:bold;margin:10px;">Note: development of this plugin continues under a new name. It is highly recommend that you download and set-up the new
					version of this plugin: <a href="http://wordpress.org/extend/plugins/newsletter-sign-up/">Newsletter Sign-Up</a></p>
