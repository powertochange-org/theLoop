...
function classic_default_settings( $settings ) {
	...
	$settings->classic_use_fitvids = true;
	...
	$menu = array(
		__( "Theme General", "wptouch-pro" ) => array ( 'general', 
			array(
				...
				array( 'checkbox', 'classic_use_fitvids', __( 'Use FitVids.js video formatting script', "wptouch-pro" ), __( 'Loads the fitvids.js file, which automatically scales videos responsively.', "wptouch-pro" ), array( 'ipad' ) ),
