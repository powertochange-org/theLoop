...
function wptouch_setup_general_tab() {
	...
	$plugin_compat_settings[] = array( 
		...
		__( 'Method to use when included functions.php', 'wptouch-pro' ), 
		__( 'The direct method loads functions.php directly, and is the recommended option.  If that method fails, an alternative method is provided which attempts to clean up the functions.php for inclusion - this method requires write access to your desktop theme directory and will cause hidden files to be written there.' , 'wptouch-pro' ),
		array( 
			'direct' => __( 'Include file directly', 'wptouch-pro' ), 
			'translate' => __( 'Translate constants and create new files', 'wptouch-pro' )
		) 
	);	
		...
		array(
			...
			__( 'Advertising &amp; Stats', 'wptouch-pro' ) => array ( 'advertising-stats-options', 
				array(
					...
					array( 'text', 'adsense_id', __( 'Adsense Publisher ID', 'wptouch-pro' ), __( 'Enter your full Publisher ID - this is the value of the "google_ad_client" parameter in the Adsense code that Google supplies.', 'wptouch-pro' ) ),
					array( 'text', 'adsense_slot_id', __( 'Adsense Slot ID', 'wptouch-pro' ), __( 'Your Adsense Slot ID - this is the value of the "google_ad_slot" parameter in the Adsense code that Google supplies.', 'wptouch-pro' ) ),						
					array( 'text', 'adsense_channel', __( 'Adsense Channel ID', 'wptouch-pro' ), __( 'Your Adsense channel (deprecated when using the new Google ad method)', 'wptouch-pro' ) ),			
