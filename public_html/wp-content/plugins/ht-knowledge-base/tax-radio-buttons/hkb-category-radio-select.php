...
Modified for use with the Heroic Knowledge Base plugin
...
class HT_Knowledge_Base_Category_Radio_Select {
    static $taxonomy = 'ht_kb_category';
    static $taxonomy_metabox_id = 'ht-kb-category-div';
    static $post_type= 'ht_kb';
    ...
    public function add_meta_box() {  
        add_meta_box( 'ht_kb_category', __('Article Category', 'ht-knowledge-base'),array(__CLASS__,'metabox'), static::$post_type ,'side','core');  
    }  
    ...
    public static function metabox( $post ) {  
     ...
     public function admin_script(){  
        wp_register_script( 'radiotax', plugins_url( 'js/hkb-category-radio-select-js.js',  __FILE__  )  , array('jquery'), null, true ); // We specify true here to tell WordPress this script needs to be loaded in the footer  
...
HT_Knowledge_Base_Category_Radio_Select::load();
?>