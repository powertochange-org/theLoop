            ...
            <div class="wrap about-wrap">
                ...
                <div class="feature-section col two-col">
                    ...
                    <div>
                        ...
                        <p><?php printf(__('Visit <a href="%s" target="_blank">Hero Themes</a>, or signup with the form below for more tips, guides and addons to harness the power of your new Knowledge Base', 'ht-knowledge-base') , 'http://herothemes.com'); ?></p>
                        <!-- Sign up form -->
