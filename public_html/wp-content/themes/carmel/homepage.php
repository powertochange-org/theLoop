...
<div id="content">
	<div style='position:relative; top:-43px;'>
		<?php 
			...
			$pictures = array($folder.'Summer.jpg', $folder.'Staff_Conference_Loop_Banner.png', $folder.'RBC.jpg', $folder.'Health_Wellness.jpg', $folder.'RRSP.jpg', $folder.'Branding.jpg');
			$links    = array('/all-staff/summer-fun/', 'http://staffconference.com/', '/corporate-discounts/discounts-across-canada/rbc-group-banking/', '/training-development/healthwellness/', '/wp-content/uploads/2013/06/Personality-Questionnaire.pdf', '/forms-information/ptc-branding-conference-resources/');
		?>
