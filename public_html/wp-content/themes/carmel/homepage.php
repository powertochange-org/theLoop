...
<div id="content">
	<div style='position:relative; top:-43px;'>
		<?php 
			...
			$pictures = array($folder.'SES_Banner_Loop.jpg', $folder.'RBC.jpg', $folder.'DayOfPrayer.jpg', $folder.'JobBoardBanner.jpg', $folder.'WellnessNews.jpg');
			$links    = array('/training-development/staff-engagement/staff-engagement-survey-2014/', '/corporate-discounts/discounts-across-canada/rbc-group-banking/', '/worldwide-day-of-prayer/', '/training-development/job-board/', '/training-development/healthwellness/wellness-news/');
		?>
