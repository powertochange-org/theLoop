...
<div id="content">
	<div id="main-content" class='form-item'>
		...
		$link = "";
		?>
		<table style='width:100%;margin:20px 0;border-collapse: collapse;'><tr>
		<?php for ($i = 0; $i < count($parts); $i ++){
			$link .= "/$parts[$i]";
			if ($i < count($parts) - 2){
				if ($i % 3 == 0 and $i > 0) {?>
					<tr></table><table style='width:100%;margin:-25px 0 30px 0;border-collapse: collapse;'><tr><td class ='crumbs' style='width:22px;'><img src='<?php bloginfo('template_url'); ?>/img/forms_level_grey.png' width='22' height='37' /></td>
				<?php } ?>
			...
			<?php } else { 
				if ($i % 3 == 0 and $i > 0) {?>
					</tr></table><table style='width:100%;margin:-25px 0 30px 0;border-collapse: collapse;'><tr><td class ='crumbs' style='width:22px;'><img src='<?php bloginfo('template_url'); ?>/img/forms_level.png' width='22' height='37' /></td>
				<?php } ?>
