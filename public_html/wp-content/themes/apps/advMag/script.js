var advMag = {
	...
	printAddress: function(address){
		return "<input placeholder='Line4' data-orgval='" + address.line4 + "' value='" + address.line4 + "' /><br />" +
			"<input placeholder='Line1' data-orgval='" + address.line1 + "' value='" + address.line1 + "' /><br />" +
			"<input placeholder='Line2' data-orgval='" + address.line2 + "' value='" + address.line2 + "' /><br />" +
			"<input placeholder='Line3' data-orgval='" + address.line3 + "' value='" + address.line3 + "' /><br />" +
			"<input placeholder='Line3' data-orgval='" + address.city + "' value='" + address.city + "' /><br />" +
			"<input placeholder='Province' data-orgval='" + address.state + "' value='" + address.state + "' /><br />" +
			"<input placeholder='Postal Code' data-orgval='" + address.postalCode + "' value='" + address.postalCode + "' /><br />" +
			"<input placeholder='Country' data-orgval='" + address.country + "' value='" + address.country + "' />";
	...
	printMethodSelection: function(value){
		return "<select data-orgval='" + value + "'>" +
