...
?>
<?php get_header(); ?>
    <link href="<?php echo get_stylesheet_directory_uri(); ?>/workflow-style.css?ver=1.0.6" rel="stylesheet" type="text/css" />
    ...
    <script language="javascript" type="text/javascript" src="<?php echo get_stylesheet_directory_uri(); ?>/workflow/script.js?ver=1.0.11"></script>
    <?php
